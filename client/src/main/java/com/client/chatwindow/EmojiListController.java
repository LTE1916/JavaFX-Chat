...
import com.client.emoji.EmojiOne;
...
public class EmojiListController {
  ...
  private Node createEmojiNode(Emoji emoji) {
    ...
    stackPane.setOnMouseClicked(e->{
      MainLauncher.controllers.forEach((s, o) -> System.out.println(s));
      ChatController controller = (ChatController) MainLauncher.controllers.get("ChatController");
      controller.addToMessageBox(emoji.getUnicode());
    });
